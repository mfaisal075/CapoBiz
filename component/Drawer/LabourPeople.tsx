...
export default function LabourPeople() {
  ...
  const handleUpdateLabr = async () => {
    if (
      !editForm.labr_name ||
      !editForm.labr_cnic ||
      !editForm.labr_contact ||
      !editForm.labr_address
    ) {
      Toast.show({
        type: 'error',
        text1: 'Missing Fields',
    ...
    try {
      const res = await axios.post(`${BASE_URL}/updatelabour`, {
        ...
        labour_name: editForm.labr_name.trim(),
        cnic: editForm.labr_cnic,
        contact: editForm.labr_contact,
        email: editForm.labr_email,
        ...
        address: editForm.labr_address.trim(),
      });
      ...
      <ImageBackground
                ...
                <View style={styles.table}>
                  ...
                  <View style={styles.infoRow}>
                    <View
                      ...
                      <Text style={styles.text}>{item.labr_contact}</Text>
                    </View>
                    <View
                      style={{
                        flexDirection: 'row',
                      ...
                      <Text style={styles.text}>{item.labr_cnic}</Text>
                    </View>
                    <View
                      style={{
                        flexDirection: 'row',
        ...
        <Modal isVisible={customer}>
          <View
            ...
            <View style={{flex: 1, justifyContent: 'flex-end'}}>
              <TouchableOpacity onPress={handleAddLabr}>
                <View
                  style={{
        ...
        <Modal isVisible={isModalV}>
          <View
            ...
            <View
              ...
              <TouchableOpacity onPress={handleDeleteLabr}>
                <View
                  style={{
                    backgroundColor: '#144272',
                    borderRadius: 5,
          ...
          <ScrollView
            ...
            <View style={[styles.row, {marginLeft: 10, marginRight: 10}]}>
              <TextInput
                ...
                onChangeText={t => handleEditInputChange('labr_cnic', t)}
              />
            </View>
            ...
            <View style={[styles.row, {marginLeft: 10, marginRight: 10}]}>
              <TextInput
                ...
                onChangeText={t => handleEditInputChange('labr_contact', t)}
              />
            </View>
            ...
            <View style={[styles.row, {marginLeft: 10, marginRight: 10}]}>
              <TextInput
                ...
                onChangeText={t => handleEditInputChange('labr_sec_contact', t)}
              />
            </View>
            ...
            <View style={[styles.row, {marginLeft: 10, marginRight: 10}]}>
              <TextInput
                ...
                onChangeText={t =>
                  handleEditInputChange('labr_third_contact', t)
                }
              />
            </View>
            ...
            <View style={{flex: 1, justifyContent: 'flex-end'}}>
              <TouchableOpacity onPress={() => handleUpdateLabr()}>
                <View
                  style={{
                    backgroundColor: '#144272',
                    height: 30,
        ...
        <Modal isVisible={view}>
          <View
            ...
            <ScrollView>
              {viewLabour.map(item => (
                <View style={styles.table} key={item.labr_cnic}>
                  <View style={[styles.cardContainer]}>
                    <View style={{alignItems: 'center', marginBottom: 16}}>
                      {item.labr_image ? (
                        <Image
                          source={{uri: item.labr_image}}
