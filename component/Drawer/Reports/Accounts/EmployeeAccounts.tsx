                  ...
                  <View style={styles.row}>
                    <View>
                      ...
                      <Text style={styles.subText}>
                        <Text style={{fontWeight: '600'}}>Total Earning: </Text>
                        {formatNumber(item.empac_earning) ?? '0'}
                      </Text>
                      <Text style={styles.subText}>
                        <Text style={{fontWeight: '600'}}>
                          Total Withdraw:{' '}
                        </Text>
                        {formatNumber(item.empac_withdraw_amount) ?? '0'}
                      </Text>
                      <Text style={styles.subText}>
                        <Text style={{fontWeight: '600'}}>Balance: </Text>
                        {formatNumber(item.empac_balance) ?? '0'}
                      </Text>
                    </View>
                  </View>
                </View>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <View style={styles.card}>
                  ...
                  <View style={styles.row}>
                    <View>
                      <Text style={styles.name}>{item.empac_invoice_no}</Text>
                      <Text style={styles.subText}>
                        <Text style={{fontWeight: '600'}}>Total Earning: </Text>
                        {formatNumber(item.empac_earning) ?? '0'}
                      </Text>
