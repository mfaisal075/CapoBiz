          ...
          <ScrollView
            ...
            <View
              ...
              <DropDownPicker
                ...
                listItemLabelStyle={{color: '#144272'}}
              />
              <TouchableOpacity onPress={toggleeditcustomer}>
                <Image
                  style={{
                    tintColor: '#144272',
                    width: 22,
            ...
            <View
              ...
              <View
                ...
                <RadioButton
                  value="EnableOpeningBalance"
                  status={
                    radioeditType === 'EnableOpeningBalance'
                      ? 'checked'
                      : 'unchecked'
                  }
                  color="#144272"
                  uncheckedColor="#144272"
                  onPress={() => setradioeditType('EnableOpeningBalance')}
                />
                <Text
                  style={{
                    color: '#144272',
            ...
            <View
              ...
              <DropDownPicker
                items={editpaymentTypeItem}
                open={editpaymentType}
                setOpen={seteditpaymentType}
                value={editcurrent}
                setValue={seteditcurrentpaymentType}
                placeholder="Payment Type"
                placeholderStyle={{color: '#144272'}}
                textStyle={{color: '#144272'}}
                arrowIconStyle={{tintColor: '#144272'}}
        ...
        <Modal isVisible={editcustomer}>
          <View
            ...
            <View
              ...
              <TouchableOpacity onPress={() => seteditcustomer(!editcustomer)}>
                <Image
                  style={{
                    width: 15,
                    height: 15,
            ...
            <TouchableOpacity onPress={togglebtnedit}>
              <View
                style={{
                  alignSelf: 'center',
                  backgroundColor: '#144272',
        ...
        <Modal isVisible={btnedit}>
          <View
            ...
            <View
              ...
              <TouchableOpacity onPress={() => setbtnedit(!btnedit)}>
                <View
                  style={{
                    backgroundColor: '#144272',
                    borderRadius: 5,
                      ...
                      <View style={styles.table}>
                        <View style={[styles.cardContainer]}>
                          ...
                          <View style={styles.infoGrid}>
                            ...
                            <Text style={styles.valu}>{item.CustomerArea}</Text>
