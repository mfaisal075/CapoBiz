  ...
  const ViewModal = [
    {
      "CompanyName": "Nu",
      "AgencyName": null,
      "SupplierName": "naeem@gmail.com",
      "Contact1": "0322-2222222",
      "Contact2": "03001234567",
      "Contact3": null,
      "Email": null,
      "SupplierArea": "gujranwala",
      "Address": "Gujranwala",
      "OpeningBalance": null,    
      "PaymentType": null,
    ...
    const [customerType, setcustomerType] = React.useState<'addacustomer' | 'string'>(
        'addacustomer',
      );
    ...
    const [currentcustomereditarea, setCurrentcustomereditarea] = useState<string | null>(
      '',
    );
    ...
    const [radioeditType, setradioeditType] = React.useState<'alsocustomer' | 'string'>(
      'alsocustomer',
    );
...
<View style={{
    ...
    <View
          ...
          <Modal isVisible={edit}>
            <ScrollView
              ...
              <View
                  style={{
                       flexDirection: 'row',
                    marginLeft: 5,marginTop:-4,marginBottom:-8
                  }}>
                  <RadioButton
                    value="alsocustomer"
                    status={
                      radioeditType === 'alsocustomer' ? 'checked' : 'unchecked'
                    }
                    color="#144272"
                    uncheckedColor="#144272"
                    onPress={() => setradioeditType('alsocustomer')}
                  />
                  <Text
                    style={{
                      color: '#144272',
     ...
     <View
                ...
                <DropDownPicker
                  ...
                  listItemLabelStyle={{color: '#144272'}}
                />
                <TouchableOpacity onPress={toggleeditarea}>
                  <Image
                    style={{
                      tintColor: '#144272',
                      width: 22,
          ...
          <Modal isVisible={editarea}>
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => seteditarea(!editarea)}>
                  <Image
                    style={{
                      width: 15,
                      height: 15,
              ...
              <TouchableOpacity onPress={toggleareaeditbtn}>
                <View
                  style={{
                    alignSelf: 'center',
                    backgroundColor: '#144272',
          ...
          <Modal isVisible={areaeditbtn}>
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => setareaeditbtn(!areaeditbtn)}>
                  <View
                    style={{
                      backgroundColor: '#144272',
                      borderRadius: 5,
    ...
    <View style={styles.infoGrid}>
      ...
      <Text style={styles.valu}>{item.CompanyName}</Text>
  
      <Text style={styles.labl}>Agency Name:</Text>
      <Text style={styles.valu}>{item.AgencyName ?? 'N/A'}</Text>
      ...
      <Text style={styles.valu}>{item.Contact1}</Text>
  
      <Text style={styles.labl}>Contact 2:</Text>
      <Text style={styles.valu}>{item.Contact2}</Text>
  
      <Text style={styles.labl}>Contact 3:</Text>
      <Text style={styles.valu}>{item.Contact3 ?? 'N/A'}</Text>
  
      <Text style={styles.labl}>Email:</Text>
      <Text style={styles.valu}>{item.Email ?? 'N/A'}</Text>
  
      <Text style={styles.labl}>Supplier Area:</Text>
      <Text style={styles.valu}>{item.SupplierArea ?? 'N/A'}</Text>
  
      <Text style={styles.labl}>Address:</Text>
      <Text style={styles.valu}>{item.Address ?? 'N/A'}</Text>
  
      <Text style={styles.labl}>Opening Balance:</Text>
      <Text style={styles.valu}>{item.OpeningBalance}</Text>
  
      <Text style={styles.labl}>Payment Type:</Text>
      <Text style={styles.valu}>{item.PaymentType}</Text>
  
      <Text style={styles.labl}>Transaction Type:</Text>
      <Text style={styles.valu}>{item.TransactionType}</Text>
